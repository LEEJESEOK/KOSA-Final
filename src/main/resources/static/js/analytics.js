...
*/
    ...
    function Z(a, b, c, d) {
        c.href && (a = X(a, b, c.href, void 0 === d ? !1 : d),
        r.test(a) && (c.href = a))
    }
    function oa(a, b, c) {
        if (c && c.action) {
            ...
            if ("get" === d) {
                ...
                e || (d = v.createElement("input"),
                d.setAttribute("type", "hidden"),
                d.setAttribute("name", a),
                d.setAttribute("value", b),
                c.appendChild(d))
            } else
                "post" === d && (a = X(a, b, c.action),
                r.test(a) && (c.action = a))
        }
    }
    function ca(a) {
...
*/
    ...
    var bd = function(a) {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j96", "sr=1"],
        b && a.push("_f=" + b),
