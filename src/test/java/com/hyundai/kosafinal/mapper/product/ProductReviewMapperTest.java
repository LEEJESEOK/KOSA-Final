...
class ProductReviewMapperTest {
    ...
    @Test
    void selectProductReviewByEmail() {
        String email = "wlgns95";

        List<ProductReviewDTO> productReviewList = productReviewMapper.selectProductReviewByEmail(email);

        for (ProductReviewDTO productReview : productReviewList) {
